                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="manufacturer" name="manufacturer"
                                         value="${vehicle.constructeur}" placeholder="${vehicle.constructeur}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="modele" name="modele"
                                         value="${vehicle.modele}" placeholder="${vehicle.modele}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" min="2" max="9" class="form-control" id="seats" name="seats"
                                        value="${vehicle.nb_places}" placeholder="${vehicle.nb_places}" required>
                                    </div>
                                </div>
                            <div class="box-footer">
                                <button type="submit" class="btn btn-info pull-right">Modifier</button>
                                <button type="button" onclick="window.location.href='${pageContext.request.contextPath}/cars'"
